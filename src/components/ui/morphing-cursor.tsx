...
export function MagneticText({
  ...
  return (
    ...
    >
      {/* Base text layer */}
      <span className="text-3xl sm:text-4xl md:text-5xl font-bold tracking-tight text-foreground text-center">
        {text}
      </span>
      ...
      >
        ...
        >
          <span className="text-3xl sm:text-4xl md:text-5xl font-bold tracking-tight text-background text-center whitespace-nowrap">
            {hoverText ?? text}
          </span>
        </div>
      </div>
